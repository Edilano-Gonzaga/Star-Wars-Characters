let currentPageUrl = 'https://swapi.dev/api/planets/' //Foi usado Let porque esse valor da variavel vai ficar mudando, let e var pode ser redeclarado o const não pode é um valor constante, pega a visão não esquecer disso.//
    ...
    try {
        ...
        responseJson.results.forEach((character) => {
            ...
            card.onclick = () =>{
                ...
                const characterDiameter = document.createElement("span")
                characterDiameter.className = "character-details"
                characterDiameter.innerText = `Diametro: ${character.diameter}`

                const rotation_period = document.createElement("span")
                rotation_period.className = "character-details"
                rotation_period.innerText = `Periodo_Rotacao: ${character.rotation_period}`
                ...
                modalContent.appendChild(characterDiameter)
